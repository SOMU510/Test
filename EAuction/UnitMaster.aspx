<%@ Page Title="" Language="C#" MasterPageFile="~/EAuction/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UnitMaster.aspx.cs" Inherits="eAuction.UnitMaster" %>
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="row form-group">
                                <div class="col-ak100">
                                    <label class="col-form-label" id="LABEL" runat="server">Unit Name<span class="text-red"> *</span></label>
                                    <asp:TextBox ID="txtUnitName" runat="server" CssClass="form-control" AutoComplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvUnitName" Display="Dynamic" runat="server" SetFocusOnError="True" ErrorMessage="This field is mandatory" ControlToValidate="txtUnitName" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="SNo.">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField Visible="false" ID="hdfUnitId" runat="server" Value='<%# Eval("Unit_Id") %>' />
