<%@ Page Language="C#" AutoEventWireup="true" Inherits="YCS.CustomError" CodeBehind="CustomError.aspx.cs" %>
            ...
            <form id="form2" runat="server">
                <div class="form-group row">
                    <div class="border-radius">
                        <div class="col-ak50">
                            <center>
                                <img src='<%= YCS.YCS_Configuration.CUSTOM_ERROR_PAGE_IMAGE_URL %>' class="img-responsive" />
                            </center>
                        </div>
                        <div class="col-ak2" style="height: 350px; border-left: 2px solid darkseagreen">
                        </div>

                        <div class="col-ak48">
                            <h2 class="w3layouts-main"><span style="color: orangered">Welcome To </span><span style="color: forestgreen"><%= YCS.YCS_Configuration.LOGIN_PAGE_PRODUCT_NAME %></span></h2>
                            <center>
                                <h4>Custom Error</h4>
                            </center>
                            <h3 class="text-center">
                                <i class="fa fa-warning text-blue"></i>Oops! Something went wrong.
                            </h3>
                            <h4 class="text-center">Please Contact To Administrator</h4>
                            <center>
                                <u><b><a href='<%= YCS.YCS_Configuration.CODE_LOGIN_PAGE_URL %>' class="text-purpleblue">
                                    <h5>Redirect To Login</h5></b></u>
                                </a>
                            </center>
                        </div>
                    </div>
