<%@ Page Title="" Language="C#" MasterPageFile="~/EAuction/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RoleMaster.aspx.cs" Inherits="eAuction.RoleMaster" %>
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <span id="spanHeader" runat="server" class="sub-title">Role Master</span>
                                <hr />
                            </div>
                            ...
                            <div class="row form-group">
                                    ...
                                    <asp:DropDownList ID="ddlRoleType" runat="server" CssClass="form-control" AutoComplete="off" Visible="false">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvRoleType" Display="Dynamic" runat="server" InitialValue="0" SetFocusOnError="True" ErrorMessage="This field is mandatory" ControlToValidate="ddlRoleType" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    <asp:HiddenField Visible="false" ID="hdfRoleId" runat="server" Value="0" />
                                    <asp:HiddenField Visible="false" ID="hdfIsEditable" runat="server" />
                                </div>
                                <div class="col-ak100">
                                    <label class="col-form-label" id="LABEL" runat="server">Role Name<span class="text-red"> *</span></label>
                                    <asp:TextBox ID="txtRoleName" runat="server" CssClass="form-control" AutoComplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvRoleName" Display="Dynamic" runat="server" SetFocusOnError="True" ErrorMessage="This field is mandatory" ControlToValidate="txtRoleName" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="SNo.">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField Visible="false" ID="hdfRoleId" runat="server" Value='<%# Eval("Role_Id") %>' />
                                                    <asp:HiddenField Visible="false" ID="hdfRoleCode" runat="server" Value='<%# Eval("Role_Code") %>' />
                                                    ...
                                                    <asp:HiddenField Visible="false" ID="hdfRoleTypeId" runat="server" Value='<%# Eval("Role_Type_Enum_Id") %>' />
                                                    <asp:HiddenField Visible="false" ID="hdfIsEditable" runat="server" Value='<%# Eval("Is_Editable") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Role Code" Visible="false">
                                                <ItemTemplate>
