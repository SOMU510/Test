<%@ Page Title="" Language="C#" MasterPageFile="~/EAuction/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CompanyTypeMaster.aspx.cs" Inherits="eAuction.CompanyTypeMaster" %>
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <span id="spanHeader" runat="server" class="sub-title">Company Type Master</span>
                                <hr />
                            </div>

                            <div class="row form-group">
                                <div class="col-ak100">
                                    <label class="col-form-label" id="LABEL" runat="server">Company Type Name<span class="text-red"> *</span></label>
                                    <asp:TextBox ID="txtCompanyTypeName" runat="server" CssClass="form-control" AutoComplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvCompanyTypeName" Display="Dynamic" runat="server" SetFocusOnError="True" ErrorMessage="This field is mandatory" ControlToValidate="txtCompanyTypeName" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="SNo.">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField Visible="false" ID="hdfCompanyTypeId" runat="server" Value='<%# Eval("Company_Type_Id") %>' />
                                            ...
                                            <asp:TemplateField HeaderText="Company Type Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCompanyTypeName" runat="server" Text='<%# Eval("Company_Type_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Company Type Code" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCompanyTypeCode" runat="server" Text='<%# Eval("Company_Type_Code") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
