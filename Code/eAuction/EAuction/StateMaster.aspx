<%@ Page Title="" Language="C#" MasterPageFile="~/EAuction/AdminMaster.Master" AutoEventWireup="true" CodeBehind="StateMaster.aspx.cs" Inherits="eAuction.StateMaster" %>
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <span id="spanHeader" runat="server" class="sub-title">State Master</span>
                                <hr />
                            </div>

                            <div class="row form-group">
                                <div class="col-ak100">
                                    <label class="col-form-label">State Name<span class="text-red"> *</span></label>
                                    <asp:TextBox ID="txtStateName" runat="server" CssClass="form-control" AutoComplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvStateName" Display="Dynamic" runat="server" SetFocusOnError="True" ErrorMessage="This field is mandatory" ControlToValidate="txtStateName" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    <asp:HiddenField ID="hdfStateId" runat="server" Value="0" Visible="false" />
                                </div>
                            </div>
