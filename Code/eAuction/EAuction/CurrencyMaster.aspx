<%@ Page Title="" Language="C#" MasterPageFile="~/EAuction/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CurrencyMaster.aspx.cs" Inherits="eAuction.CurrencyMaster" %>
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <span id="spanHeader" runat="server" class="sub-title">Currency Master</span>
                                <hr />
                            </div>

                            <div class="row form-group">
                                <div class="col-ak100">
                                    <label class="col-form-label" id="LABEL" runat="server">Currency Name<span class="text-red"> *</span></label>
                                    <asp:TextBox ID="txtCurrencyName" runat="server" CssClass="form-control" AutoComplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvCurrencyName" Display="Dynamic" runat="server" SetFocusOnError="True" ErrorMessage="This field is mandatory" ControlToValidate="txtCurrencyName" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                            ...
                            <div class="row GridScroll">
                                <div class="col-ak100">
                                    <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table table-bordered table-striped" EmptyDataText="No Records Found" OnPreRender="grdData_PreRender" OnRowCommand="grdData_RowCommand">
                                        <Columns>
                                            <asp:TemplateField HeaderText="SNo.">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSrno" runat="server" Text='<%# Container.DataItemIndex+1 %>'></asp:Label>
                                                    <asp:HiddenField Visible="false" ID="hdfCurrencyId" runat="server" Value='<%# Eval("Currency_Id") %>' />
                                            ...
                                            <asp:TemplateField HeaderText="Currency Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCurrencyName" runat="server" Text='<%# Eval("Currency_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Currency Code" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCurrencyCode" runat="server" Text='<%# Eval("Currency_Code") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
